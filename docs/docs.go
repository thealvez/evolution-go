...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/call/ring": {
            "post": {
                "description": "Place an experimental outbound voice call, optionally play a recorded audio after answer, and hang up automatically. Accepted requests are queued per instance and return immediately.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_EvolutionAPI_evolution-go_pkg_call_service.RingCallStruct"
                        }
                    }
                ],
                "responses": {
                    ...
                    "429": {
                        "description": "Call queue full for this instance",
                        "schema": {
                            "$ref": "#/definitions/gin.H"
                        }
                    },
